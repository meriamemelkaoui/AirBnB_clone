...
class TestConstructor(unittest.TestCase):
    ...
    """
    user = User()
    user.email = "Mery@Alx.com"
    user.password = "Mery@30"
    user.first_name = "Meriame"
    user.last_name = "Melkaoui"
    ...
    def test_create_instance_without_kwargs(self):
        ...
        self.assertEqual(self.user.email, "Mery@Alx.com")
        self.assertEqual(self.user.password, "Mery@30")
        self.assertEqual(self.user.first_name, "Meriame")
        self.assertEqual(self.user.last_name, "Melkaoui")
    ...
    def test_create_instance_with_kwargs(self):
        ...
        self.assertEqual(new_user.email, "Mafa@Alx.com")
        self.assertEqual(new_user.password, "new_password")
        self.assertEqual(new_user.first_name, "Youssef")
        self.assertEqual(new_user.last_name, "Mafamane")

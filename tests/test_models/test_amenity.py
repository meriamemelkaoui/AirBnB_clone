...
class TestConstructor(unittest.TestCase):
    ...
    def test_create_instance_without_kwargs(self):
        ...
        self.assertEqual(self.amenity.name, "Mery")
        self.assertEqual(self.amenity.id, "124-124-124")
    ...
    def test_create_instance_with_kwargs(self):
        ...
        self.assertEqual(new_amenity.name, "Mery")
        self.assertEqual(new_amenity.id, "124-124-124")

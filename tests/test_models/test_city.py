...
class TestConstructor(unittest.TestCase):
    ...
    def test_create_instance_without_kwargs(self):
        ...
        self.assertEqual(self.city.name, "Mery")
        self.assertEqual(self.city.id, "124-124-124")
    ...
    def test_create_instance_with_kwargs(self):
        ...
        self.assertEqual(new_city.name, "Mery")
        self.assertEqual(new_city.id, "124-124-124")
        ...
        self.assertEqual(new_city.name, "Mafa")
        self.assertEqual(new_city.__dict__["name"], "Mafa")
